    ...
    return (
        <Container>
            <div id="bride-groom">
                ...
                <h2 className="text-3xl md:text-5xl text-center py-12 font-bold" data-aos="fade-down">Bride & Groom</h2>
                <div className="flex flex-col w-full md:w-3/4 mx-auto">
                    ...
                    <div className="flex flex-row flex-wrap justify-between" data-aos="fade-right">
                        <div className="w-full md:w-auto p-5">
