...
const CoverPage = ({ isOnline }: User) => (
    <div className={styles.background}>
        <div className="flex flex-col w-full h-3/4 md:w-3/4 pt-5 md:pt-10 m-auto text-center justify-evenly">
            ...
            <Link href={isOnline ? "/online/home" : "/home"}>
                <button className="rounded-3xl w-1/3 md:w-1/6 mx-auto p-2 md:p-3 text-blue-800 bg-white">Open Invitation</button>
            </Link>
        </div>
    </div>
);
