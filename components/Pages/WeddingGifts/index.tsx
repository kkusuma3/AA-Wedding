...
const WeddingGifts = () => (
    <Container>
        <div className="flex flex-col py-20 text-center space-y-10">
            ...
            <div className="flex flex-row flex-wrap p-4 w-full md:w-1/2 mx-auto justify-around place-items-center bg-white">
